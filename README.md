# Aerovision-V1
适用于航空图库的AI LLM，目的是帮助图库审核员准确高效的审核图片

## 简介

Aerovision-V1 是一个AI 审核微服务，负责对上传的航空照片进行自动化质量审核和内容识别。
...
| 项目 | 说明 |
|------|------|
| [QuanPhotos-backend](https://github.com/yourname/QuanPhotos-backend) | QuanPhotos后端 API 服务 |
| [QuanPhotos-web](https://github.com/yourname/QuanPhotos-web) | QuanPhotos前端 Web 应用 |
| [Aviation_VOX](https://github.com/Aviation_VOX/Aviation_VOX) | Aviation VOX 航空图库 |
